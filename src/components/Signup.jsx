...
import { Box, Button,  FormControl,  FormControlLabel,  Grid, Link, Paper, Radio, RadioGroup, TextField, Typography } from '@mui/material';
...
const Signup=()=>{ 
    ...
    return(
        <Grid>
            <Paper elevation={10} style={paperStyle}>
                <Grid align='center'>
                   ...
                   <Typography variant='h4' gutterBottom color='#c51162' sx={{ textDecoration: 'underline' }}>Create Account</ Typography>
                </Grid>
                <p>
      ...
      >
        ...
        />      </p>  
                <p>
                    <h6>By clicking Sign Up, you agree to our Terms, Privacy Policy. You may receive SMS notifications from us and can opt out at any time.</h6>
