...
const Requestform = () => {
  ...
  return (
    <div>
      <Card sx={{ minWidth: 275, height:700, width:600, marginLeft:50, marginTop:3 }}>
      <CardContent>
        <Typography sx={{ fontSize: 26, fontFamily:'initial', textDecoration:'underline'}} color="black" gutterBottom>
          Request Form
        </Typography>
