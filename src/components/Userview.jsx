import {
  ...
  TextField,
  Typography,
  Box, AppBar,Toolbar,IconButton, Dialog, DialogTitle, List, Container, ListItem
} from "@mui/material";
    ...
    <div>
        ...
        <AppBar position="static">
          <Toolbar>
            ...
            <Typography variant="h6" component="div" sx={{ flexGrow: 1 }}>
              ...
              <Button color="inherit" onClick={()=>setopen(true)}>Request</Button>
            <Button color="inherit">Logout</Button>
          </Toolbar>
        </AppBar>
      </Box>

      <Dialog open={open} onClose={close} sx={{height:"100%", width:"100%"}} >
      ...
      <Container>
        ...
        >
          ...
          <ListItem>
          <Button variant="contained" sx={{marginTop: "2%",marginLeft:"28%",width:"50%"}} onClick={close}>Back</Button>
          </ListItem>
          </List>
          </Container>
      </Dialog>
