    ...
    <div>
      ...
      <Box
        sx={{
          ...
          backgroundRepeat: "no-repeat",
          backgroundImage: `url("https://i.ibb.co/3v4gL2J/image.png")`,
        }}
      >
        <Grid container sx={{}}>
          <Card
          ...
          >
            <CardContent>
              ...
              <ul style={{ textAlign: "start", fontSize: "20px" }}>
                ...
                <li>
                  Can donate blood to those with any blood type (universal
                  donor).
                </li>
          ...
          >
            <CardContent>
              ...
              <ul style={{ textAlign: "start", fontSize: "20px" }}>
                ...
                <li>
                  Can receive blood from those with type A, B, AB, or O
                  (universal recipient).
                </li>
              </ul>
            </CardContent>
        ...
        <Box sx={{ marginTop: "20px", marginLeft: 30 }}>
          ...
          <ul style={{ textAlign: "start", fontSize: "21px" }}>
            <li>
              Donors must be at least 17 years old (16 years old with parental
              consent in some states).
            </li>
            <li>Donors must weigh at least 110 pounds.</li>
            <li>
              Donors must be in good health and feeling well on the day of
              donation.
            </li>
            <li>
              Donors must not have donated blood in the last 56 days (or 112
              days for double red cell donations).
            </li>
            <li>
              Donors must meet other eligibility requirements related to travel,
          ...
          <ul style={{ textAlign: "start", fontSize: "21px" }}>
            <li>
              The blood donation process usually takes about an hour from start
              to finish.
            </li>
            <li>
              Donors will be asked to complete a health questionnaire and have
              their vitals checked before the donation.
            </li>
            <li>
              The actual donation only takes about 10-15 minutes and involves a
              small needle prick.
            </li>
            <li>
              After the donation, donors will be offered snacks and drinks to
          ...
          <ul style={{ textAlign: "start", fontSize: "21px" }}>
            <li>
              ...
              <b>
                Answer: Yes, donating blood is safe and all blood donation
                procedures are sterile and strictly regulated.
              </b>
            </li>
            <li>
              How often can I donate blood?{" "}
              <b>
                Answer: You can donate whole blood every 56 days or double red
            ...
            <li>
              ...
              <b>
                Answer: You may feel a slight pinch or discomfort during the
                needle prick, but it should not be painful. Most donors report
                feeling only mild discomfort.
              </b>
            </li>
            <li>
              Can I donate blood if I have a tattoo or piercing?{" "}
              <b>
                Answer: Yes, as long as the tattoo or piercing was done at a
                licensed facility and has fully healed.
              </b>{" "}
            </li>
          </ul>
        </Box>
        ...
        <Box height={"300px"} width={"100%"}>
          ...
          <Typography fontSize={"17px"} fontWeight={"bold"}>
            Contact:854729164389
          </Typography>
          <Typography fontSize={"17px"} fontWeight={"bold"}>
            somebloodbank@gmail.com
          </Typography>
        </Box>
      </Box>
    </div>
